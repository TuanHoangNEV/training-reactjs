export const Play = () => {
    return (
        <svg width="45" height="45" fill="#ffffff" viewBox="0 0 24 24">
...
export const RandomMusicsFalse = () => {
    return (
        <svg width="25" height="25" fill="none" stroke="#ffffff" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24">
...
export const RandomMusicsTrue = () => {
    return (
        <svg width="25" height="25" fill="none" stroke="#23bd23" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24">
  <path d="m18 4 3 3-3 3"></path>
  <path d="m18 20 3-3-3-3"></path>
  <path d="M3 7h3a5 5 0 0 1 5 5 5 5 0 0 0 5 5h5"></path>
  <path d="M9 16.001c-.865.65-1.918 1-3 .999H3"></path>
...
export const VolumeOff = () => {
  ...
  <path fillRule="evenodd" d="M11.26 3.691A1.2 1.2 0 0 1 12 4.8v14.4a1.2 1.2 0 0 1-2.048.848L5.503 15.6H2.4a1.2 1.2 0 0 1-1.2-1.2V9.6a1.2 1.2 0 0 1 1.2-1.2h3.103l4.449-4.448a1.2 1.2 0 0 1 1.308-.26Zm3.492 5.06a1.2 1.2 0 0 1 1.696 0L18 10.304l1.552-1.551a1.2 1.2 0 1 1 1.696 1.696L19.697 12l1.551 1.552a1.2 1.2 0 0 1-1.696 1.696L18 13.697l-1.552 1.551a1.2 1.2 0 0 1-1.696-1.696L16.303 12l-1.551-1.552a1.2 1.2 0 0 1 0-1.696Z" clipRule="evenodd"></path>
</svg>
    )
}
export const VolumeOn = () => {
    return (
        <svg width="20" height="20" fill="#ffffff" viewBox="0 0 24 24">
  <path fillRule="evenodd" d="M11.26 3.691A1.2 1.2 0 0 1 12 4.8v14.4a1.199 1.199 0 0 1-2.048.848L5.503 15.6H2.4a1.2 1.2 0 0 1-1.2-1.2V9.6a1.2 1.2 0 0 1 1.2-1.2h3.103l4.449-4.448a1.2 1.2 0 0 1 1.308-.26Zm6.328-.176a1.2 1.2 0 0 1 1.697 0A11.967 11.967 0 0 1 22.8 12a11.966 11.966 0 0 1-3.515 8.485 1.2 1.2 0 0 1-1.697-1.697A9.563 9.563 0 0 0 20.4 12a9.565 9.565 0 0 0-2.812-6.788 1.2 1.2 0 0 1 0-1.697Zm-3.394 3.393a1.2 1.2 0 0 1 1.698 0A7.178 7.178 0 0 1 18 12a7.18 7.18 0 0 1-2.108 5.092 1.2 1.2 0 1 1-1.698-1.698A4.782 4.782 0 0 0 15.6 12a4.78 4.78 0 0 0-1.406-3.394 1.2 1.2 0 0 1 0-1.698Z" clipRule="evenodd"></path>
</svg>
    )
}
export const Home = () => {
    return (
        <svg width="35" height="35" fill="#000000" viewBox="0 0 24 24">
...
export const Search = () => {
    return (
        <svg width="30" height="30" fill="none" stroke="#000000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24">
...
export const SearchWhite = () => {
    return (
        <svg width="25" height="25" fill="none" stroke="#5f6062" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24">
  <path d="M11 3a8 8 0 1 0 0 16 8 8 0 1 0 0-16z"></path>
  <path d="m21 21-4.35-4.35"></path>
</svg>
    )
...
export const Menu = () => {
    return (
        <svg width="28" height="28" fill="none" stroke="#000000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24">
